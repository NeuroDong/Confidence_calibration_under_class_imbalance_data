#参考论文：《Deep Networks with Stochastic Depth》
...
def resnet18_StoDepth_lineardecay(cfg):
    """Constructs a ResNet_StoDepth_lineardecay-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_StoDepth_lineardecay(StoDepth_BasicBlock, prob_0_L=[1,0.5], multFlag=True, layers=[2, 2, 2, 2],num_classes=cfg.MODEL.NUM_ClASSES)
    pretrained = False 
    if pretrained:
...
@META_ARCH_REGISTRY.register()
def resnet34_StoDepth_lineardecay(cfg):
    """Constructs a ResNet_StoDepth_lineardecay-34 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_StoDepth_lineardecay(StoDepth_BasicBlock, prob_0_L=[1,0.5], multFlag=True, layers=[3, 4, 6, 3], num_classes=cfg.MODEL.NUM_ClASSES)
    pretrained = False 
    if pretrained:
...
@META_ARCH_REGISTRY.register()
def resnet50_StoDepth_lineardecay(cfg):
    """Constructs a ResNet_StoDepth_lineardecay-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_StoDepth_lineardecay(StoDepth_Bottleneck, prob_0_L=[1,0.5], multFlag=True, layers=[3, 4, 6, 3], num_classes=cfg.MODEL.NUM_ClASSES)
    pretrained = False
    if pretrained:
...
@META_ARCH_REGISTRY.register()
def resnet101_StoDepth_lineardecay(cfg):
    """Constructs a ResNet_StoDepth_lineardecay-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_StoDepth_lineardecay(StoDepth_Bottleneck, prob_0_L=[1,0.5], multFlag=True, layers=[3, 4, 23, 3], num_classes=cfg.MODEL.NUM_ClASSES)
    pretrained = False
    if pretrained:
...
@META_ARCH_REGISTRY.register()
def resnet152_StoDepth_lineardecay(cfg):
    """Constructs a ResNet_StoDepth_lineardecay-152 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet_StoDepth_lineardecay(StoDepth_Bottleneck, prob_0_L=[1,0.5], multFlag=True, layers=[3, 8, 36, 3], num_classes=cfg.MODEL.NUM_ClASSES)
    pretrained = False
    if pretrained:
